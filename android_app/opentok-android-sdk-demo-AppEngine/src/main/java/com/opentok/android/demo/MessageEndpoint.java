 ...
 */
@Api(name = "messageEndpoint", namespace = @ApiNamespace(ownerDomain = "opentok.com", ownerName = "opentok.com", packagePath = "android.demo"))
...
public class MessageEndpoint {
     ...
     */
    private static final String API_KEY = "AIzaSyBebE-FdCk8FE5jfMjZHnFsH2CGOmr0Fzc";
